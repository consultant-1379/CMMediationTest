...
*/
public class NetSimHandlerDataProvider implements DataProvider{
	...
	/**
	 * Method to check if NE is started
	 * @return booelan
	 */
	public boolean expectedStartNE(Host host, NetsimNE node){
		return node.isStarted() ;
	}
	/**
	 * Method to check if NE is stoped
	 * @return booelan
	 */
	public boolean expectedStopNE(Host host, NetsimNE node){
		netsimHandler = new NetsimHandler(host);
		return !node.isStarted();
	}
